...
<!-- Fonts -->
    ...
    <link href="https://fonts.googleapis.com/css?family=Lemonada|Lalezar&display=swap" rel="stylesheet">
<!-- Bootstrap CSS -->
                ...
                <ul class="navbar-nav mr-auto p-0 pl-4 navbar-right-top">
                    ...
                    <li class="nav-item dropdown nav-user">
                        ...
                        <div class="dropdown-menu text-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                            ...
                            <a class="dropdown-item" href="#"><i class="fas fa-user ml-2"></i>مدیریت حساب کاربری</a>
                            <a class="dropdown-item" href="#"><i class="fas fa-power-off ml-2"></i>خروج</a>
